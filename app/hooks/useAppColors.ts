...
export function useAppColors() {
  ...
  return {
    ...
    textCaption:   dark ? "#42425a" : "#9ca3af",
    // Borders / Dividers
    ...
    // === STATUS — sin rojo, colores formales ===
    success: {
